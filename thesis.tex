...
The energy band dispersion are parameterized for the three uppermost valence bands (VBs;  v1 to v3) and the lowest conduction band (CB; c1), based on the $\mathbf k \cdot \mathbf p$ method but expanded up to high order. 
...
at 3.00 and 3.09 eV, where v1 and v2 represent the first uppermost valence band and the second uppermost valence band, respectively. However, also the energetically lower VBs contributes to the high absorption coefficient. 
