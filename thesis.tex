...
the \textbf{Fig. \ref{nrel}} represents the newest ways to create electricity from sunlight, such as perovskite cells, for which the maximum conversion efficiency is 17.9\% by the korean research institute of chemical technology (KRICT). ?????add more text about his new technologies???
