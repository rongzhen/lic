...
In order to demonstrate the anisotropic and non-parabolic of energy bands further, the constant energy surface $S_j(E)$ is determinded for CuInSe\textsubscript{2} and CuGaSe\textsubscript{2}.
