...
For most of zinc blende type semiconductors, valence bands of the valence band edges are 3-fold degenerate at the $\Gamma$ point in the Brillouin zone without considering spin. However,
they are 6-fold degenerate considering spin. In of case of SOC, it splits the 6-fold degeneracy into higher energy 4-fold bands (heavy hole (HH) and light hole (LH) bands) and lower energy 2-fold bands (Splitting-Off (SO) bands).
...
Here, $\varDelta_{SO}$ is the spin-orbit splitting energy of the valence band. The average effective mass $m_{SO}$ around the $\Gamma$ point can be calculated from  \textbf{Eq. \ref{9054}} 
