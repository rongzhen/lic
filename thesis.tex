...
\begin{center}
 ...
 \epsfig{file=kth_svv_indu_eng_manage.eps,width=4 cm}
  ...
  \vspace{12pt}
  \textsc{\LARGE{\textbf{{{\color{red}??Theoretical Investigations of CIGS thin films??}}}}}
  \vspace{12pt}
...
\begin{flushright}
 Materialvetenskap\\
 KTH\\
{\color{red}ISRN KTH/MSE--12/09--SE+AMFY/AVH
...
\copyright \hspace{3pt} {\color{red}Rongzhen Chen, 2015}
...
Chalcopyrite copper indium gallium diselenide (CIGS) is interesting both from a scientifically point of view and today also commercially for thin-film solar cell technology.
...
spectra are in good agreement. We find that the{\color{red} v?-c? and v?-c? transitions in the Brillouin zone edge are responsible for the main absorption peaks at ?? and ?? eV}.
...
There are mainly three kinds of solar energy technologies \cite{boyle2004renewable,Chiras201007}. The first one is solar thermal,which utilizes the flat sunlight collector plates to harness the energy from sunlight to heat water for use in industries, homes, and pools.
...
Chalcopyrite copper indium gallium diselenide (CIGS) is seen as one of the most promising solar cell material for the near future. 
