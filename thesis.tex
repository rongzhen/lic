...
The energy band dispersions are parameterized for the valence bands (VBs; where $v$1, $v$2 and $v$3 represent the first, second, and third uppermost VB, respectively) and the lowest conduction band (CB; $c$1), based on the $\mathbf k \cdot \mathbf p$ method but expanded up to high order. 
