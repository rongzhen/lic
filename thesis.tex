...
\section{Solar cells}
In the worldwide, the solar cell conversion efficiencies in all different types of solar cells are improved remarkably \cite{nrel}. From \textbf{Fig. \ref{nrel}}, the highest efficiency for multijunction cells, crystalline silicon (c-Si) cells,
...
Actually, $L$, $M$, and $N$ do not need to be calculated becaues $A$, $B$, and $C$ are the only fitting parameters in realistic application. .
