...
\noindent Chalcopyrite copper indium gallium diselenide (Cu(In, Ga)Se\textsubscript{2} = CuIn\textsubscript{1-x}Ga\textsubscript{x}Se\textsubscript{2})
...
The energy band dispersions are parameterized for the three uppermost valence bands (VBs;  $v$1 to $v$3,  where $v$1, $v$2 and $v$3 represent the first, second, and third uppermost valence band, respectively) and the lowest conduction band (CB; $c$1), based on the $\mathbf k \cdot \mathbf p$ method but expanded up to high order. 
...
at 3.00 and 3.09 eV. However, also the energetically lower VBs contribute to the high absorption coefficient. 
