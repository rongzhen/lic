...
is between 1.0 eV to 1.7 eV for this alloy \cite{kumar2013cation, chen2012band, chen2011parameterization, persson2009impurity}. CIGS does not contain any toxic element.
...
To date, the highest conversion efficiency in lab situation for the solar cells based on CIGS is 23.3\%.


\subsection{Crystal structure}
The crystal structure of CIGS can be derived from the zinc blende crystal structure of zinc selenide (ZnSe). In \textbf{Fig. \ref{crystal_cigs}}, the crystal structures of ZnSe and CIGS are presented {\color{red} Ref}. 
